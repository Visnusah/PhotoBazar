...
export default Dashboard;
      ...
      setPhotos(mockUserPhotos);
      setStats({
        totalPhotos: mockUserPhotos.length,
        totalViews: mockUserPhotos.reduce((sum, photo) => sum + photo.views, 0),
        totalEarnings: mockUserPhotos.reduce((sum, photo) => sum + photo.earnings, 0),
        thisMonthSales: 45
      });
      setLoading(false);
    }, 1000);
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage your photos and track your earnings
              </p>
            </div>
            <Link
              to="/sell"
          ...
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{stats.thisMonthSales} sales</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          {photos.length > 0 ? (
                    ...
                    <tr key={photo.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          {photo.status === 'active' ? 'Active' : 'Pending Review'}
                        </span>
                      </td>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                Start by uploading your first photo to begin earning.
              </p>
              <Link to="/sell" className="btn-primary">
